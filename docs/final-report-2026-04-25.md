...
| 入口 | URL | 验证状态 |
|---|---|---|
| 用户前端 | http://localhost:80 | 200 |
| 管理前端 | http://localhost:8081 | 200 |
| API 网关 | http://localhost:8080 | 200 |
| 用户服务 | http://localhost:8001 | 200 |
| 商品服务 | http://localhost:8002 | 200 |
| 订单服务 | http://localhost:8003 | 200 |
| 推荐服务 | http://localhost:8004 | 200 |
| 秒杀服务 | http://localhost:8005 | 200 |
| 管理服务 | http://localhost:8006 | 200 |
| Python rank | http://localhost:8010 | 200 |
| Prometheus | http://localhost:9090 | 200 |
| Grafana | http://localhost:3001 (admin/admin123) | 200 |
| Loki | http://localhost:3100 | 200 |
| AlertManager | http://localhost:9093 | 200 |
| SkyWalking UI | http://localhost:8082 | 200 |
